...
export default function OrganizationsPage() {
  ...
  const showLoading = useConsistentLoading(loading || isLoading);
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200">
          ...
          {isLoading ? (
            ...
            <div className="grid gap-6">
              {organizations.map((org) => (
                <div key={org.id} className="bg-white rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                  {/* Card Header */}
                  <div className="p-6 border-b border-slate-100">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h3 className="text-2xl font-bold text-slate-900">{org.name}</h3>
                          <div className="flex items-center space-x-3 text-base text-slate-600 mt-1">
                      ...
                      <div className="flex items-center space-x-3">
                        <button 
                          ...
                          className="flex items-center space-x-2 bg-blue-50 text-blue-700 hover:bg-blue-100 hover:text-blue-800 px-4 py-2 rounded-xl transition-colors font-medium"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                          </svg>
                        ...
                        <button 
                          ...
                          className="flex items-center space-x-2 bg-slate-50 text-slate-700 hover:bg-slate-100 hover:text-slate-800 px-4 py-2 rounded-xl transition-colors font-medium"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      {org.contactInfo?.email && (
                        <div className="bg-slate-50 rounded-xl p-4">
                          ...
                          <p className="text-slate-900 font-medium">{org.contactInfo.email}</p>
                        </div>
                      )}
                      ...
                      {org.contactInfo?.phone && (
                        <div className="bg-slate-50 rounded-xl p-4">
                          ...
                          <p className="text-slate-900 font-medium">{org.contactInfo.phone}</p>
                        </div>
                      )}
                      ...
                      {org.contactInfo?.website && (
                        <div className="bg-slate-50 rounded-xl p-4">
                          ...
                          <p className="text-slate-900 font-medium truncate">{org.contactInfo.website}</p>
                        </div>
                      )}
