    ...
    <div className="h-screen bg-slate-50 flex overflow-hidden">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-200 ease-in-out lg:relative lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-screen overflow-hidden">
          {/* Logo */}
          <div className="flex items-center px-6 py-5 border-b border-slate-200 bg-white">
            <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg">
              <span className="text-white font-bold text-xl">N</span>
            </div>
            <span className="ml-3 text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">NFTicate</span>
          </div>
              ...
              <>
                ...
                <div className="px-4 py-3">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3 flex-1 min-w-0">
                      ...
                      <p className="text-sm text-slate-600 truncate capitalize">
                ...
                <div className="px-4 pb-4">
                  <button
                    ...
                    className="flex items-center w-full px-4 py-3 text-base font-medium text-red-700 rounded-xl hover:bg-red-50 hover:text-red-800 transition-all duration-300 hover:scale-105 hover:shadow-sm"
                  >
